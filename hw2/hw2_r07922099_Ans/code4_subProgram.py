...
# for Q5-2 ******************************************
print("Enter new Nb for ")
data = input('> second part authentication: ').strip()
...
print("data new Nb = ",data , type(data))
Nb_b64 = data
r.sendline(Nb_b64 + "||" + msg1)
print(str(r.recv(),'utf-8'))
print("!!!!!!!!!!!!!copy back to code4_NSprotocol.py \n=> " , str(r.recv(),'utf-8'))
